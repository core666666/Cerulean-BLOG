...
//    public static String theme = "amaze";
    ...
    public String page(HttpServletRequest request, @PathVariable("pageNum") int pageNum) { // @PathVariable是spring3.0的一个新功能：接收请求路径中占位符的值
    ...
    public String category(HttpServletRequest request, @PathVariable("categoryName") String categoryName) {
        return category(request, categoryName, 1);  // 路径中不指定page则默认为1
    }
