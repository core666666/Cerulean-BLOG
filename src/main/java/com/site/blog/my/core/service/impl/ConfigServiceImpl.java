...
public class ConfigServiceImpl implements ConfigService {
    ...
    public static final String websiteName = "Cerulean Blog";
    public static final String websiteDescription = "personal blog 是 SpringBoot2+Thymeleaf+Mybatis 建造的个人博客网站.SpringBoot实战博客源码.个人博客搭建";
    public static final String websiteLogo = "/admin/dist/img/logo2.png";
    public static final String websiteIcon = "/admin/dist/img/logo2.png";

    public static final String yourAvatar = "/admin/dist/img/adminhead.png";
    public static final String yourEmail = "";
    public static final String yourName = "Cerulean";

    public static final String footerAbout = "your personal blog. have fun.";
    public static final String footerICP = "";  // 底部备案号 浙ICP备17008806号-3
    public static final String footerCopyRight = "@2023 Cerulean";
    public static final String footerPoweredBy = "Cerulean BLOG";
